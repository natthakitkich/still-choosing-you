...
`ถ้ามองย้อนกลับไปเธอคือคนแรก และเป็นคนเดียวที่ทำให้เรากลับมามีพลังใจ มีรอยยิ้ม และค่อย ๆ กลับมารู้สึกว่าชีวิตมันเบาขึ้นมาก ๆ ในปีนึ้
เราไม่เคยคิดเลยว่าตัวเองจะกลับมามีความสุขได้มากขนาดนี้ กลับมาดีขึ้นได้ขนาดนี้ มันเหมือนหัวใจที่เคยพังทขายและสูญเสียตัวตตนมันค่อย ๆ ฟื้นตัวและกลับมาเป็นเราในเวอร์ชั่นที่เราภูมิใจและรู้สึกว่ามันดีกับตัวเราและคนรอบข้าง
ซึ่งทั้งหมดนี้ เราพูดได้เต็มปากว่ามันเกิดขึ้นเพราะมีเธออยู่ตรงนี้…ข้าง ๆ เรา ไม่ว่าที่ผ่านมาเราจะทำตัวแย่แค่ไหน แต่เธอก็ยังไม่ปล่อยมือเรา`,
...
ถูกใส่ใจ และถูกรัก เรามีความสุขมากจริง ๆ
...
เราอยากทิ้งทุกเรื่องที่หนักใจ ทุกความผิดพลาดไว้ในปีที่ผ่านมา แล้วจับมือกันก้าวไปข้างหน้าในปีใหม่ ด้วยหัวใจที่เรียนรู้ เติบโต และเข้าใจกันมากขึ้น`,
...
Still choosing you…
เรายังเลือกเธอ
วันนี้ พรุ่งนี้ และในทุกวันที่เราจะเดินไปข้างหน้าเราก็ยังเลือกเธอนะ`,
...
function render() {
  ...
  setTimeout(() => {
    ...
    nextBtn.textContent =
      pageIndex === pages.length - 1 ? "จบแล้ว" :
      pageIndex === 0 ? "เปิดการ์ดปีใหม่" : "ถัดไป";
